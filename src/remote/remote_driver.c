...
static virHypervisorDriver hypervisor_driver = {
    ...
    .domainCheckpointCreateXML = remoteDomainCheckpointCreateXML, /* 5.2.0 */
    .domainCheckpointGetXMLDesc = remoteDomainCheckpointGetXMLDesc, /* 5.2.0 */
    .domainListCheckpoints = remoteDomainListCheckpoints, /* 5.2.0 */
    .domainCheckpointListChildren = remoteDomainCheckpointListChildren, /* 5.2.0 */
    .domainCheckpointLookupByName = remoteDomainCheckpointLookupByName, /* 5.2.0 */
    .domainHasCurrentCheckpoint = remoteDomainHasCurrentCheckpoint, /* 5.2.0 */
    .domainCheckpointGetParent = remoteDomainCheckpointGetParent, /* 5.2.0 */
    .domainCheckpointCurrent = remoteDomainCheckpointCurrent, /* 5.2.0 */
    .domainCheckpointIsCurrent = remoteDomainCheckpointIsCurrent, /* 5.2.0 */
    .domainCheckpointHasMetadata = remoteDomainCheckpointHasMetadata, /* 5.2.0 */
    .domainCheckpointDelete = remoteDomainCheckpointDelete, /* 5.2.0 */
    .domainBackupBegin = remoteDomainBackupBegin, /* 5.2.0 */
    .domainBackupGetXMLDesc = remoteDomainBackupGetXMLDesc, /* 5.2.0 */
    .domainBackupEnd = remoteDomainBackupEnd, /* 5.2.0 */
};
